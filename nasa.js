...
function sendRovers(fullInitialCommand) {
  let arrFullInitialCommand = fullInitialCommand.split("\n")
  ...
  for (var n = 0; n < arrFullInitialCommand.length; n++) { 
    console.log("\nn: ", n)
    ...
    let returnFromRover = rover.execute(landingPosition, movements)
